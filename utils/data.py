...
class iCIFAR224(iData):
    ...
    def __init__(self,use_input_norm, seed_file):
        self.seed_file = seed_file
        # print(self.seed_file)
        if use_input_norm:
    ...
    def download_data(self):
        ...
        # breakpoint()
        self.train_targets, self.train_data  = self.make_low_shot(self.train_data, self.train_targets, seed_file= self.seed_file)
        # breakpoint()
        self.test_data, self.test_targets = test_dataset.data, np.array(
            test_dataset.targets
        )
    def make_low_shot(self, data, targets, seed_file):
        assert os.path.exists(seed_file), 'keep file does not exist'
...
class iImageNet100(iData):
    ...
    def download_data(self):
        ...
        train_dir = "/mnt/50f2d3fa-182a-44fa-9f1f-0cabddd2c5a7/Harddisk/Teja/Rohit/Imagenet_subset_100/train"
        test_dir = "/mnt/50f2d3fa-182a-44fa-9f1f-0cabddd2c5a7/Harddisk/Teja/Rohit/Imagenet_subset_100/val"
...
class cars(iData):
    ...
    def download_data(self):
        train_dir = 'data/scars/cars_train/'
        test_dir = 'data/scars/cars_test/'
