...
def split(dataset_name, seed, percent):
    ...
    subset_file = subset_dir / f'shot{samples_per_class}_seed{seed}.txt'
    ...
    subset_file = subset_dir / f'shot{samples_per_class}_seed{seed}_cls.txt'
    print(f'writing to {subset_file}...')
    with open(subset_file, 'w') as f:
        for i in indices:
