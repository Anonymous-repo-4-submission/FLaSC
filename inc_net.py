...
def get_convnet(args, pretrained=False):
    ...
    #NCM or NCM w/ Finetune
    ...
    elif name=="pretrained_vit_b16_224_mocov3" or name=="vit_base_patch16_224_mocov3":
        # model=timm.create_model("vit_base_patch16_224",pretrained=True, num_classes=0)
        model=timm.create_model("vit_base_patch16_224_in21k", pretrained=True, num_classes=0)
        ...
        print("check load these mocov3 weights", msg)
        model.out_dim=768
        return model.eval()
    ...
    # VPT
        ...
        if args["model_name"]=="adapter" :
            ...
            elif name=="pretrained_vit_b16_224_mocov3_adapter":
                model = vision_transformer_adapter.vit_base_patch16_224_mocov3_adapter(num_classes=0,
                    global_pool=False, drop_path_rate=0.0, tuning_config=tuning_config)
                model.out_dim=768
            else:
